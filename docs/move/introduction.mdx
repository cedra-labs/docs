...
1. **Complete the Counter Tutorial**: Start with our **[beginner-friendly counter guide](https://docs.cedra.network/getting-started/counter)** - build and deploy in under 10 minutes!

2. **Explore Real-World Guides**: Ready for more? Dive into our **[comprehensive real-world guides](https://docs.cedra.network/real-world-guides)** that covering Fungible Assets, NFT and many other real world apps
:::
