...
:::tip Navigation
**⬅️ Previous:** [Understanding Transactions](/concepts/transactions/understanding-transactions)
**📍 You are here:** States
**➡️ Next:** [Proofs and Verification](/concepts/transactions/proofs-and-verification)
**🏠 Overview:** [Blockchain Architecture](/concepts/blockchain)
:::

The Cedra blockchain's state represents the complete snapshot of all accounts, resources, and data at any given moment. This global state is the cumulative result of all transactions executed since genesis. To understand how individual transactions create these state changes, see [Understanding Transactions](/concepts/transactions/understanding-transactions).
...
Continue your exploration of Cedra's transaction system:

- **[Understanding Transactions](/concepts/transactions/understanding-transactions)** - Transaction anatomy and lifecycle
- **[Proofs and Verification](/concepts/transactions/proofs-and-verification)** - How state changes are cryptographically proven
- **[Blockchain Architecture](/concepts/blockchain)** - Network topology and consensus mechanisms