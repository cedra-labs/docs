...
With Rust and Node.js installed, you're ready to:

✨ **[Install the Cedra CLI](/getting-started/cli)** - Your next stop  
📝 **[Write First Smart Contracts](/getting-started/counter)** - Create and deploy Move modules  