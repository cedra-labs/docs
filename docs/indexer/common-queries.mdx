...
- 🎮 **[Interactive Playground](https://cloud.hasura.io/public/graphiql?endpoint=https://graphql.cedra.dev/v1/graphql)** - Test these queries live (no setup needed!)
- 🚀 **[SDK Integration Guide](/indexer/sdk)** - Add these queries to your TypeScript/JavaScript app
- 💻 **[Run Your Own Indexer](/indexer/local-setup)** - Set up a local instance for development
- 📡 **[Real-time Updates](/indexer/transaction-stream)** - Stream blockchain data as it happens

**Building something specific?**
- 🎯 **[First NFT Collection](/guides/first-nft)** - Launch your NFT project
- 💰 **[Create Fungible Assets](/guides/first-fa)** - Build your own token
- 🔄 **[DEX Integration](/guides/dex)** - Add swap functionality
- 🏗️ **[Move Smart Contracts](/move)** - Write on-chain logic