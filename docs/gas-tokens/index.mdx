...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="border rounded-lg p-4">
    <h3>📝 Create Stablecoin</h3>
    <p>Learn how to create and deploy your own stablecoin as gas token</p>
    <a href="/gas-tokens/custom-gas-tokens">Coming Soon →</a>
  </div>

  <div className="border rounded-lg p-4">
    <h3>🗳️ Stablecoin Governance</h3>
    <p>Understand the governance process for stablecoin approval</p>
